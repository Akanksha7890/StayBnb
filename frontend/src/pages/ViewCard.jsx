...
function ViewCard() {
  ...
  return (
   <div className='w-[100%] min-h-screen bg-[white] flex items-center justify-start gap-[10px] flex-col overflow-y-auto relative pb-[30px]'>
             ...
             {cardDetails.host != userData._id && <button className='px-[30px] py-[10px] bg-[red] text-[white] hover:first: text-[18px] md:px-[100px] rounded-lg   text-nowrap' onClick={()=>setBookingPopUp(prev => !prev)}> 
                Reserve
             </button>}
             </div>
            ...
            {updatePopUp && <div className='w-[100%] h-[100%] flex items-center justify-center  bg-[#000000c6] absolute top-[0px] z-[100] backdrop-blur-sm'>
                ...
                <RxCross2 className='w-[30px] h-[30px] bg-[red] cursor-pointer absolute top-[6%] left-[25px] rounded-[50%] flex items-center justify-center' onClick={()=>setUpdatePopUp(false)}/>
                  ...
                  <form action="" className='max-w-[900px] w-[90%] h-[550px] flex items-center justify-start flex-col  gap-[10px] overflow-auto mt-[50px] text-white bg-[#0a0a0abd] p-[20px] rounded-lg' onSubmit={(e)=>{e.preventDefault()}} 
                         >
